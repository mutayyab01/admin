...
const EditWarehouse = () => {
    ...
    // Fetch warehouse data and cities on component mount
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch warehouse data
                const warehouseResponse = await axios.get(`${API_URL}/Warehouses/${id}`);
                setFormData(warehouseResponse.data);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${API_URL}/Warehouses/${id}`, formData);

            if (response.status === 200) {
                setSuccessMessage("The warehouse has been updated successfully!"); // Set success message
            ...
            setError(err.response?.data?.message || 'Error updating warehouse');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <MasterLayout>
            <Breadcrumb title="Edit Warehouse" />
            <div className="card">
                <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="card-title">Edit Warehouse Details</h5>
                    <button
                        type="button"
