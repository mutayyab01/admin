...
const EditProduct = () => {
    ...
    // Fetch product data, categories, and warehouses on component mount
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                setSuccessMessage("The product has been updated successfully!"); // Set success message
        ...
        <MasterLayout>
            ...
            <div className="card">
                <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="card-title">Edit Product Details</h5>
                    <button
                        type="button"
