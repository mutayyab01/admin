...
const EditDeal = () => {
    ...
    // Fetch deal data and products on component mount
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${API_URL}/Deals/${id}`, formData);

            if (response.status === 200) {
                setSuccessMessage("The deal has been updated successfully!"); // Set success message
            ...
            setError(err.response?.data?.message || 'Error updating deal');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <MasterLayout>
            <Breadcrumb title="Edit Deal" />
            <div className="card">
                <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="card-title">Edit Deal Details</h5>
                    <button
                        type="button"
